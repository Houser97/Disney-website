        ...
        <header>
            <div className='options-header'>
                ...
                <div className='search option'>
                    ...
                    <div className='text-option'>SEARCH</div> 
                </div>
                <div className='watchlist option'>
                    ...
                    <div className='text-option'>WATCHLIST</div> 
                </div>
                <div className='originals option'>
                    ...
                    <div className='text-option'>ORIGINALS</div> 
                </div>
                <div className='movies option'>
                    ...
                    <div className='text-option'>MOVIES</div> 
                </div>
                <div className='series option'>
                    ...
                    <div className='text-option'>SERIES</div> 
                </div>
            </div>
